...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { description: @hotel.description, image: @hotel.image, name: @hotel.name, place: @hotel.place, rating: @hotel.rating } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { description: @hotel.description, image: @hotel.image, name: @hotel.name, place: @hotel.place, rating: @hotel.rating } }
